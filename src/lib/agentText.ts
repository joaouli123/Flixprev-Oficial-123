...
const AGENT_PRESENTATION_PRESETS: AgentPresentationPreset[] = [
  ...
  { badge: "AIT", title: "Incapacidade Temporária", order: 209, match: ["ait", "incapacidade temporaria"] },
  { badge: "AA", title: "Auxílio-Acidente", order: 210, match: ["aa", "auxilio-acidente", "auxilio acidente"] },
  { badge: "25%", title: "25% Incapacidade Permanente", order: 211, match: ["25aip", "25%", "acrescimo na aposentadoria por incapacidade"] },
  ...
  { badge: "BPC - Idoso/PCD", title: "Benefício Prestação Continuada", order: 222, match: ["bpc", "beneficio de prestacao continuada"] },
  { badge: "CRPS", title: "Conselho Recursos Previdência Social", order: 223, match: ["crps", "conselho de recursos da previdencia social"] },
