...
const AGENT_PRESENTATION_PRESETS: AgentPresentationPreset[] = [
  ...
  { badge: "Processo Administrativo Previdenciário", title: "Processo Administrativo Previdenciário", order: 202, featured: true, match: ["procadm", "processo administrativo previdenciario", "p.a.p"] },
  { badge: "A.pré103", title: "Aposentadoria Pré EC103", order: 203, match: ["a.pre103", "a.pre 103", "apre103", "aposentadoria pre ec103"] },
  { badge: "Apiurb", title: "Aposentadoria Idade Urbana", order: 204, match: ["apiurb", "aposentadoria idade urbana"] },
  { badge: "AEsp", title: "Aposentadoria Especial", order: 205, match: ["aesp", "aposentadoria especial"] },
  ...
  { badge: "ARur", title: "Aposentadoria Rural", order: 207, match: ["arur", "aposentadoria rural"] },
  { badge: "Rec", title: "Auxílio-Reclusão", order: 208, match: ["rec", "auxilio-reclusao", "auxilio reclusao"] },
  { badge: "PMor", title: "Pensão por Morte", order: 209, match: ["pmor", "pensao por morte"] },
  { badge: "SMar", title: "Salário-Maternidade", order: 210, match: ["smar", "salario-maternidade", "salario maternidade"] },
  { badge: "AIP", title: "Aposentadoria por Incapacidade Permanente", order: 211, match: ["aip", "aposentadoria incapacidade permanente"] },
  { badge: "AIT", title: "Incapacidade Temporária", order: 212, match: ["ait", "incapacidade temporaria"] },
  { badge: "AA", title: "Auxílio-Acidente", order: 213, match: ["aa", "auxilio-acidente", "auxilio acidente"] },
  { badge: "AVJud", title: "Viabilidade Judicial - Auxílio por Incapacidade Temporária", order: 214, match: ["avjud", "viabilidade judicial", "aux. doenca", "aux doenca"] },
  { badge: "25%", title: "25% Sobre Aposentadoria por Incapacidade Permanente", order: 215, match: ["25aip", "25%", "acrescimo na aposentadoria por incapacidade"] },
  ...
  { badge: "RMI", title: "Cálculo de RMI", order: 218, match: ["rmi", "calculo de rmi"] },
  { badge: "AMB", title: "Manutenção de Benefícios", order: 219, match: ["amb", "manutencao de beneficios"] },
  { badge: "CQS", title: "Carência e Qualidade de Segurado", order: 220, match: ["cqs", "carencia", "qualidade de segurado"] },
  { badge: "ASoc", title: "Assistência Social", order: 221, match: ["asoc", "assistencia social"] },
  { badge: "BPC - Idoso/PCD", title: "Benefício de Prestação Continuada - Idoso e Pessoa com Deficiência", order: 222, match: ["bpc", "beneficio de prestacao continuada"] },
  ...
  { badge: "Súmulas Federais", title: "Súmulas Federais", order: 227, match: ["sumfed", "sumulas federais"] },
  { badge: "TNU", title: "Turma Nacional de Uniformização", order: 228, match: ["rtnu", "tnu", "turma nacional de uniformizacao"] },
  ...
  { badge: "REFIS-IA", title: "Agente Reforma Tributária Atual", order: 303, description: "Monitorar e interpretar as mudanças da Reforma Tributária e os impactos setoriais.", match: ["refis-ia", "reforma tributaria atual"] },
  { badge: "TAX-Rend", title: "Simulador inteligente de cálculos, deduções, retenções e alíquotas aplicáveis", order: 304, description: "Calcular tributos de renda segundo a legislação vigente, incluindo mudanças recentes.", match: ["tax-rend", "simulador inteligente de calculos", "tributos de renda"] },
  { badge: "FedTax", title: "Guia de obrigações, prazos de pagamento, retenção na fonte e impacto de reformas", order: 305, description: "Agrupa e explica tributos federais administrados pela RFB, como IRRF, IOF, CSLL e Cofins.", match: ["fedtax", "tributos federais", "retencao na fonte"] },
];
