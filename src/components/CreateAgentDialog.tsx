...
import * as LucideIcons from "lucide-react"; // Linha corrigida
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Preencha os detalhes para adicionar um novo agente.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSave}>Salvar Agente</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
